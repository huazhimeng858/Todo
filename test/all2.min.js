!function(){function e(e){return Object.prototype.toString.call(e)}function n(n){return"[object Object]"===e(n)}function i(n){return"[object Function]"===e(n)}function o(e,n){for(var i=0,o=e.length;o>i&&n.call(e,e[i],i)!==!1;i++);}function r(e){if(!p.test(e))return null;var n,i,o,r,a;if(-1!==e.indexOf("trident/")&&(n=/\btrident\/([0-9.]+)/.exec(e),n&&n.length>=2)){o=n[1];var t=n[1].split(".");t[0]=parseInt(t[0],10)+4,a=t.join(".")}n=p.exec(e),r=n[1];var b=n[1].split(".");return"undefined"==typeof a&&(a=r),b[0]=parseInt(b[0],10)-4,i=b.join("."),"undefined"==typeof o&&(o=i),{browserVersion:a,browserMode:r,engineVersion:o,engineMode:i,compatible:o!==i}}function a(e){if(s)try{var n=s.twGetRunPath.toLowerCase(),i=s.twGetSecurityID(c),o=s.twGetVersion(i);if(n&&-1===n.indexOf(e))return!1;if(o)return{version:o}}catch(r){}}function t(o,r,a){var t=i(r)?r.call(null,a):r;if(!t)return null;var b={name:o,version:d,codename:""},s=e(t);if(t===!0)return b;if("[object String]"===s){if(-1!==a.indexOf(t))return b}else{if(n(t))return t.hasOwnProperty("version")&&(b.version=t.version),b;if(t.exec){var u=t.exec(a);if(u)return b.version=u.length>=2&&u[1]?u[1].replace(/_/g,"."):d,b}}}function b(e,n,i,r){var a=m;o(n,function(n){var i=t(n[0],n[1],e);return i?(a=i,!1):void 0}),i.call(r,a.name,a.version)}var s,u={},d="-1",c=this,p=/\b(?:msie |ie |trident\/[0-9].*rv[ :])([0-9.]+)/,l=[["nokia",function(e){return-1!==e.indexOf("nokia ")?/\bnokia ([0-9]+)?/:-1!==e.indexOf("noain")?/\bnoain ([a-z0-9]+)/:/\bnokia([a-z0-9]+)?/}],["samsung",function(e){return-1!==e.indexOf("samsung")?/\bsamsung(?:\-gt)?[ \-]([a-z0-9\-]+)/:/\b(?:gt|sch)[ \-]([a-z0-9\-]+)/}],["wp",function(e){return-1!==e.indexOf("windows phone ")||-1!==e.indexOf("xblwp")||-1!==e.indexOf("zunewp")||-1!==e.indexOf("windows ce")}],["pc","windows"],["ipad","ipad"],["ipod","ipod"],["iphone",/\biphone\b|\biph(\d)/],["mac","macintosh"],["mi",/\bmi[ \-]?([a-z0-9 ]+(?= build))/],["aliyun",/\baliyunos\b(?:[\-](\d+))?/],["meizu",/\b(?:meizu\/|m)([0-9]+)\b/],["nexus",/\bnexus ([0-9s.]+)/],["huawei",function(e){var n=/\bmediapad (.+?)(?= build\/huaweimediapad\b)/;return-1!==e.indexOf("huawei-huawei")?/\bhuawei\-huawei\-([a-z0-9\-]+)/:n.test(e)?n:/\bhuawei[ _\-]?([a-z0-9]+)/}],["lenovo",function(e){return-1!==e.indexOf("lenovo-lenovo")?/\blenovo\-lenovo[ \-]([a-z0-9]+)/:/\blenovo[ \-]?([a-z0-9]+)/}],["zte",function(e){return/\bzte\-[tu]/.test(e)?/\bzte-[tu][ _\-]?([a-su-z0-9\+]+)/:/\bzte[ _\-]?([a-su-z0-9\+]+)/}],["vivo",/\bvivo(?: ([a-z0-9]+))?/],["htc",function(e){return/\bhtc[a-z0-9 _\-]+(?= build\b)/.test(e)?/\bhtc[ _\-]?([a-z0-9 ]+(?= build))/:/\bhtc[ _\-]?([a-z0-9 ]+)/}],["oppo",/\boppo[_]([a-z0-9]+)/],["konka",/\bkonka[_\-]([a-z0-9]+)/],["sonyericsson",/\bmt([a-z0-9]+)/],["coolpad",/\bcoolpad[_ ]?([a-z0-9]+)/],["lg",/\blg[\-]([a-z0-9]+)/],["android",/\bandroid\b|\badr\b/],["blackberry","blackberry"]],f=[["wp",function(e){return-1!==e.indexOf("windows phone ")?/\bwindows phone (?:os )?([0-9.]+)/:-1!==e.indexOf("xblwp")?/\bxblwp([0-9.]+)/:-1!==e.indexOf("zunewp")?/\bzunewp([0-9.]+)/:"windows phone"}],["windows",/\bwindows nt ([0-9.]+)/],["macosx",/\bmac os x ([0-9._]+)/],["ios",function(e){return/\bcpu(?: iphone)? os /.test(e)?/\bcpu(?: iphone)? os ([0-9._]+)/:-1!==e.indexOf("iph os ")?/\biph os ([0-9_]+)/:/\bios\b/}],["yunos",/\baliyunos ([0-9.]+)/],["android",function(e){return e.indexOf("android")>=0?/\bandroid[ \/-]?([0-9.x]+)?/:e.indexOf("adr")>=0?e.indexOf("mqqbrowser")>=0?/\badr[ ]\(linux; u; ([0-9.]+)?/:/\badr(?:[ ]([0-9.]+))?/:"android"}],["chromeos",/\bcros i686 ([0-9.]+)/],["linux","linux"],["windowsce",/\bwindows ce(?: ([0-9.]+))?/],["symbian",/\bsymbian(?:os)?\/([0-9.]+)/],["blackberry","blackberry"]],w=[["trident",p],["webkit",/\bapplewebkit[\/]?([0-9.+]+)/],["gecko",/\bgecko\/(\d+)/],["presto",/\bpresto\/([0-9.]+)/],["androidwebkit",/\bandroidwebkit\/([0-9.]+)/],["coolpadwebkit",/\bcoolpadwebkit\/([0-9.]+)/],["u2",/\bu2\/([0-9.]+)/],["u3",/\bu3\/([0-9.]+)/]],v=[["sg",/ se ([0-9.x]+)/],["tw",function(){var e=a("theworld");return"undefined"!=typeof e?e:"theworld"}],["360",function(e){var n=a("360se");return"undefined"!=typeof n?n:-1!==e.indexOf("360 aphone browser")?/\b360 aphone browser \(([^\)]+)\)/:/\b360(?:se|ee|chrome|browser)\b/}],["mx",function(){try{if(s&&(s.mxVersion||s.max_version))return{version:s.mxVersion||s.max_version}}catch(e){}return/\bmaxthon(?:[ \/]([0-9.]+))?/}],["qq",/\bm?qqbrowser\/([0-9.]+)/],["green","greenbrowser"],["tt",/\btencenttraveler ([0-9.]+)/],["lb",function(e){if(-1===e.indexOf("lbbrowser"))return!1;var n;try{s&&s.LiebaoGetVersion&&(n=s.LiebaoGetVersion())}catch(i){}return{version:n||d}}],["tao",/\btaobrowser\/([0-9.]+)/],["fs",/\bcoolnovo\/([0-9.]+)/],["sy","saayaa"],["baidu",/\bbidubrowser[ \/]([0-9.x]+)/],["ie",p],["mi",/\bmiuibrowser\/([0-9.]+)/],["opera",function(e){var n=/\bopera.+version\/([0-9.ab]+)/,i=/\bopr\/([0-9.]+)/;return n.test(e)?n:i}],["yandex",/yabrowser\/([0-9.]+)/],["ali-ap",function(e){return e.indexOf("aliapp")>0?/\baliapp\(ap\/([0-9.]+)\)/:/\balipayclient\/([0-9.]+)\b/}],["ali-ap-pd",/\baliapp\(ap-pd\/([0-9.]+)\)/],["ali-am",/\baliapp\(am\/([0-9.]+)\)/],["ali-tb",/\baliapp\(tb\/([0-9.]+)\)/],["ali-tb-pd",/\baliapp\(tb-pd\/([0-9.]+)\)/],["ali-tm",/\baliapp\(tm\/([0-9.]+)\)/],["ali-tm-pd",/\baliapp\(tm-pd\/([0-9.]+)\)/],["chrome",/ (?:chrome|crios|crmo)\/([0-9.]+)/],["uc",function(e){return e.indexOf("ucbrowser/")>=0?/\bucbrowser\/([0-9.]+)/:/\buc\/[0-9]/.test(e)?/\buc\/([0-9.]+)/:e.indexOf("ucweb")>=0?/\bucweb([0-9.]+)?/:/\b(?:ucbrowser|uc)\b/}],["android",function(e){return-1!==e.indexOf("android")?/\bversion\/([0-9.]+(?: beta)?)/:void 0}],["safari",/\bversion\/([0-9.]+(?: beta)?)(?: mobile(?:\/[a-z0-9]+)?)? safari\//],["webview",/\bcpu(?: iphone)? os (?:[0-9._]+).+\bapplewebkit\b/],["firefox",/\bfirefox\/([0-9.ab]+)/],["nokia",/\bnokiabrowser\/([0-9.]+)/]],m={name:"na",version:d},x=function(e){e=(e||"").toLowerCase();var n={};b(e,l,function(e,i){var o=parseFloat(i);n.device={name:e,version:o,fullVersion:i},n.device[e]=o},n),b(e,f,function(e,i){var o=parseFloat(i);n.os={name:e,version:o,fullVersion:i},n.os[e]=o},n);var i=r(e);return b(e,w,function(e,o){var r=o;i&&(o=i.engineVersion||i.engineMode,r=i.engineMode);var a=parseFloat(o);n.engine={name:e,version:a,fullVersion:o,mode:parseFloat(r),fullMode:r,compatible:i?i.compatible:!1},n.engine[e]=a},n),b(e,v,function(e,o){var r=o;i&&("ie"===e&&(o=i.browserVersion),r=i.browserMode);var a=parseFloat(o);n.browser={name:e,version:a,fullVersion:o,mode:parseFloat(r),fullMode:r,compatible:i?i.compatible:!1},n.browser[e]=a},n),n};if("object"==typeof process&&"[object process]"===process.toString()){var h=module.require("./morerule");[].unshift.apply(l,h.DEVICES||[]),[].unshift.apply(f,h.OS||[]),[].unshift.apply(v,h.BROWSER||[]),[].unshift.apply(w,h.ENGINE||[])}else{var y=navigator.userAgent||"",g=navigator.appVersion||"",z=navigator.vendor||"";s=c.external,u=x(y+" "+g+" "+z),c.detector=u}u.parse=x}();
...
c.normalScrollElements);a(".fp-section").off("click",".fp-controlArrow");b&&qa()}}})(jQuery);var includeStyleElement=function(e,t){if(!document.getElementById(t)){var n=document.createElement("style");n.id=t,"ie"===detector.browser.name&&(n.type="text/css",n.media="screen"),(document.getElementsByTagName("head")[0]||document.body).appendChild(n),n.styleSheet?n.styleSheet.cssText=e:n.appendChild(document.createTextNode(e))}},is_weixin=function(){var e=navigator.userAgent.toLowerCase();return"micromessenger"==e.match(/MicroMessenger/i)?!0:!1};$(document).ready(function(){setTimeout(function(){if(-1!=="ios android wp ce symbian blackberry meego".indexOf(detector.os.name)){$("body").addClass("phone");var e=document.documentElement.clientWidth||document.body.clientWidth;$(".toper").show(),includeStyleElement("html, body {font-size: "+e/640*40+"px}","styleid"),is_weixin()&&(document.body.scrollTop=1,document.body.scrollTop=0)}else $("body").addClass("pc");var t=function(e,t,n,o,a){var i,r,t=t||800,s=!0;return function(){var l=this,d=arguments;return a&&(i=+new Date),s===!1?!1:(s=!1,r&&(clearTimeout(r),r=null),r=setTimeout(function(){var n=+new Date-i;a&&n>=t?e.apply(l,d):o&&e.apply(l,d),s=!0},t),void(n===!0&&(e.apply(l,d),n=!1)))}},n=function(e){var t=0;"down"===e?(t=a+1,t>=5?($(".toperwrap").css("margin-top",-$("#footer").height()),a=5):($.fn.fullpage.moveTo(t),$(".toperwrap").css("margin-top",0))):"up"===e&&(t=a-1,1>=t?t=1:4===t&&(a=4),$.fn.fullpage.moveTo(t),$(".toperwrap").css("margin-top",0))},o=$("#body"),a=1;o.show(),o.on("click","#fp-nav a",function(){5===a&&$(".toperwrap").css("margin-top","0")}).on("mousewheel",t(function(e){var t=1===e.deltaY?"up":"down";n(t)},300,!0,!0,!1)).on("keyup",t(function(e){var t;38===e.keyCode?t="up":40===e.keyCode&&(t="down"),n(t)},300,!0,!0,!1)),o.on("flick",t(function(e){e.preventDefault();var t=1===e.direction?"up":"down";return n(t),!1},300,!0,!0,!1));var i=t(function(){var e=$("#fullpage").find(".section:eq(0)");e.height()<=955?e.addClass("one-small"):e.removeClass("one-small")},300,!0,!0,!1);$("body").hasClass("pc")&&($(window).on("resize",i),i());{var r=[0,function(){$(".one-fd").fadeIn(),$(".one-desc").addClass("one-descanim"),$(".toper").fadeIn()},function(){$(".two-title").addClass("two-titleanim"),$(".two-anim").fadeIn(),$(".toper").fadeIn()},function(){$(".thr-title").addClass("thr-titleanim"),$(".thr-anim").fadeIn(),$(".toper").fadeIn()},function(){$(".fou-title").addClass("fou-titleanim"),$(".fou-wrap").addClass("fou-wrapanim"),$(".toper").fadeIn()}],s=$("#fullpage");s.fullpage({anchors:["feature-one","feature-two","feature-thr","feature-fou"],navigation:!0,navigationPosition:"right",slidesNavigation:!1,css3:!0,easing:"easeInOutQuint",easingcss3:"easeInOutQuint",sectionsColor:["#fc6313","#F7F7F7","#fc6313","#FFFFFF"],afterRender:function(){r[a]&&r[a]()},resize:!1,onLeave:function(e){$(".toper").fadeOut(),$(".one-fd").fadeOut(),$(".one-desc").removeClass("one-descanim"),$(".two-title").removeClass("two-titleanim"),$(".two-anim").fadeOut(),$(".thr-title").removeClass("thr-titleanim"),$(".thr-anim").fadeOut(),$(".fou-title").removeClass("fou-titleanim"),$(".fou-wrap").removeClass("fou-wrapanim")},afterLoad:function(e,t){a=t,r[a]&&r[a]()}})}$.fn.fullpage.setAllowScrolling(!1),$.fn.fullpage.setKeyboardScrolling(!1)},100)});
;
